...
CREATE TABLE movies (
    ...
    CONSTRAINT fk_movies_countries FOREIGN KEY (country_id)
        REFERENCES countries (id),
    CONSTRAINT fk_movies_moviesadditionalinfo FOREIGN KEY (movie_info_id)
...
CREATE TABLE genres_movies (
    genre_id INT,
    movie_id INT,
    CONSTRAINT fk_genresmovies_genres FOREIGN KEY (genre_id)
        REFERENCES genres (id),
    CONSTRAINT fk_genresmovies_movies FOREIGN KEY (movie_id)
        REFERENCES movies (id)
);